...
file = open('inputfile_problem3_51.txt','r+')
m=file.read()
length=len(m)
...
emp_freq_prob=find_emperical_probability('inputfile_problem3_51.txt')

print("Emperical pmf  of each symbol in given text file is:",emp_freq_prob)
print("frequency  of each symbol in given text file is:",find_frequency('inputfile_problem3_51.txt'))
...
#Inputs for our file
#Question 3 part 2,pen and paper solution is attached
keys_codes=['e','a','c','b','d']


#Question 3 part 2,pen and paper solution is attached
values_codes_huffman=['001','1','01','0000','0001'] #Huffman codes
values_codes_shannon=['111','00','10','010','1100000000']#Shannon codes
values_codes_shannon_alias=['1100','001','100','1110','11111111110']#Shannon fano alias code
...
#Question3 part 3-Compression-Encoding,zero padding and storing as byte string
...
def read_binary_string(file_path):
                ...
                print(" input sequence in binary form is:",(''.join(binary_string1)))
                print("length of input file binary sequence is",len(binary_string1),"bytes")
                
              

read_binary_string('inputfile_problem3_51.txt')
...
#Question3 part 4-Compression-decoding,zero padding removal(header removal) and storing as byte string
...
def padding_removal_and_decoding(padded_encoded_text,reverse_mapping):
                padded_info = padded_encoded_text[:8] #first 8 bits checking
...
def decompression_algo(input_file_path,reverse_mapping):
          #Using os ,we get final name with it's available extension
                ...
                return output_file_path
#Question3 part 5,displaying all results using
#1.Huffman coding
#2.Shannon coding
...
print(compression_algo('inputfile_problem3_51.txt',codes_huff))
compressed_file=compression_algo('inputfile_problem3_51.txt',codes_huff)
binary_string1=[]
with open(compressed_file, 'rb') as output:
                          text1=output.read()
output.close()                      
print("bytearray output compressed sequence with huffman code is:",bytearray(text1),"and it's length is",len(text1))

file1 = open(compression_algo('inputfile_problem3_51.txt',codes_huff),'rb')
k_comp=file1.read()
length_comp=len(k_comp)
print("length of compressed file with huffman code is",length_comp,"bytes")
print("Decompression with huffman of Compressed file with huffman code is:")
...
print("length of decompressed file of compressed file with huffman code is",length_decomp,"bytes")
...
print(compression_algo('inputfile_problem3_51.txt',codes_shan))
compressed_file=compression_algo('inputfile_problem3_51.txt',codes_shan)
binary_string1=[]
with open(compressed_file, 'rb') as output:
                          text1=output.read()
output.close()                      
...
file1 = open(compression_algo('inputfile_problem3_51.txt',codes_shan),'rb')
k_comp=file1.read()
length_comp=len(k_comp)
print("length of compressed file with shnnon codingis",length_comp,"bytes")
print("Decompression with shannon coding of Compressed file is:")
...
k_decomp=file2.read()
length_decomp=len(k_decomp)
print("length of decompressed file of compressed file with shnnon coding is",length_decomp,"bytes")
...
print(compression_algo('inputfile_problem3_51.txt',codes_shan_alias))
compressed_file=compression_algo('inputfile_problem3_51.txt',codes_shan_alias)
file1 = open(compression_algo('inputfile_problem3_51.txt',codes_shan_alias),'rb')
k_comp=file1.read()
length_comp=len(k_comp)
binary_string1=[]
with open(compressed_file, 'rb') as output:
...
k_decomp=file2.read()
length_decomp=len(k_decomp)
print("length of decompressed file of compressed file with shannon alias coding is",length_decomp,"bytes")
